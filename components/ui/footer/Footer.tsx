    ...
    <footer className="mt-20 w-full border-t border-gray-200 bg-white py-10 text-sm text-gray-600 dark:border-gray-800 dark:bg-[#0C0A09] dark:text-gray-400">
      <div className="container mx-auto flex flex-col items-center justify-between gap-6 px-4 md:flex-row">
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 font-medium">
          <Link href="/" className="flex items-center justify-center gap-2 rounded-md transition-all hover:text-gray-900 dark:hover:text-white" aria-label="Home">
            <IoHomeOutline className="h-5 w-5" /> Home
          </Link>
