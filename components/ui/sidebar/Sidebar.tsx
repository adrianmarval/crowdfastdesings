...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {/* Sidemenu */}
      <nav
        className={clsx('fixed top-0 right-0 z-20 h-screen w-[500px] transform bg-white p-5 shadow-2xl transition-all duration-300', {
      ...
      >
        ...
        {isAuthenticated && (
          <button className="mt-10 flex w-full items-center rounded p-2 transition-all hover:bg-gray-100" onClick={handleLogOut}>
