          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="col-span-1 space-y-6 lg:col-span-7">
              <div className="overflow-hidden rounded-[24px] bg-gray-50/50 p-2 dark:bg-white/5">
                <div className="aspect-[4/3] w-full animate-pulse rounded-[16px] bg-slate-200 dark:bg-slate-800" />
                <div className="mt-2 hidden grid-cols-4 gap-2 md:grid">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="aspect-square w-full animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
                  ))}
                </div>
              </div>
            </div>
              ...
              <div>
                <div className="mb-6 flex items-start justify-between">
                  <div className="w-full">
                    ...
                    {/* Title */}
                    <div className="mb-2 h-10 w-3/4 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
                    <div className="mb-4 h-10 w-1/2 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
                    {/* Rating */}
                ...
                <div className="mb-10">
                  <div className="mb-4 h-4 w-24 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
