export default function LegalLoading() {
  return (
    <div>
      <div className="mb-8 h-12 w-64 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />

      <div className="max-w-none space-y-12">
        <section>
          <div className="mb-4 h-8 w-1/3 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
        ...
        <section>
          <div className="mb-4 h-8 w-1/4 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
          <div className="space-y-3">
            <div className="h-4 w-full animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
            <div className="h-4 w-full animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
