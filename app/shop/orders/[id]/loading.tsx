      ...
      <div className="flex w-[1000px] flex-col">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2">
          ...
          <div className="mt-5 flex flex-col gap-5">
            <div className="mb-4 h-10 w-full animate-pulse rounded bg-slate-200 dark:bg-slate-800" />

            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex flex-row items-start gap-5">
                <div className="h-[100px] w-[100px] shrink-0 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
          ...
          <div className="rounded-xl bg-white p-7 shadow-xl dark:bg-[#2f2d2d]">
            ...
            <div className="mt-10 h-12 w-full animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
          </div>
        </div>
      </div>
    </div>
